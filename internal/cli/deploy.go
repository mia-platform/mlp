...
import (
	...
	"github.com/mia-platform/mlp/pkg/deploy"
...
func DeploySubcommand(cmd *cobra.Command, options *utils.Options) {
	...
	deployCmd.Flags().StringSliceVarP(&inputPaths, "filename", "f", []string{}, "file and/or folder paths containing data to interpolate or stdin when filename is -")
