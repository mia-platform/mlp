...
```sh
go install github.com/mia-platform/mlp@v2.5.0
```

Or like this if the `install` command is not available

```sh
go get -u github.com/mia-platform/mlp@v2.5.0
```
...
```sh
curl -fsSL --proto '=https' --tlsv1.2 https://github.com/mia-platform/mlp/releases/download/v2.5.0/mlp-linux-amd64 -o /tmp/mlp
```

```sh
wget -q --https-only --secure-protocol=TLSv1_2 https://github.com/mia-platform/mlp/releases/download/v2.5.0/mlp-linux-amd64 -O /tmp/mlp
```
...
```sh
docker run ghcr.io/mia-platform/mlp:v2.5.0
```
...
[checksum]: https://github.com/mia-platform/mlp/releases/download/v2.5.0/checksums.txt "mlp checksums"
